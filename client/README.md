...
- **Resume Capability**: Pause and resume downloads anytime (if supported by server).
...
- **Google Drive Support**: Download public/private files and **entire folders** directly.
